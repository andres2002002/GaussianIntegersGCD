...
from logic.extended_gaussian_gcd import extended_gaussian_gcd

class GcdExtendedScreen(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        # --- Título ---
        self.title_label = ttk.Label(self, text="Calcular MCD Extendido", background="#2e2e2e", font=("Arial", 14, "bold"))
        ...
        self.calculate_button = ttk.Button(self, text="MCD Extendido", command=self.process)
    ...
    def process(self):
        try:
            ...
            g, u, v, steps = extended_gaussian_gcd(z, w)
            result_str = ""
            for step in steps:
                result_str += f"\n{step}"
